...
public class KeyUtils {
     ...
     * @throws XMLEncryptionException if the KEM API is unavailable (requires Java 21+), the KEM
     *          algorithm is not supported by the configured JCE provider, or key derivation fails
     */
     ...
     * @throws XMLEncryptionException if the KEM API is unavailable (requires Java 21+), the KEM
     *          algorithm is not supported by the configured JCE provider, the ciphertext is shorter
     *          than the algorithm's expected encapsulation size, or key derivation fails
     */
